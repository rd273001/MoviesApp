...
const LoadingIndicator = () => {
  return (
    <div className='fixed z-30 top-0 left-0 right-0 bottom-0 m-auto border-2 border-gray-400 py-8 px-12 items-center justify-center h-fit rounded-2xl bg-[radial-gradient(#bbb,#444)] w-fit'>
